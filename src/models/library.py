...
class Library:
    ...
    def check_length_seq_diff(self) -> tuple[int, int, int, int]:
        """Evaluation of the length (min, max) of the primary probes of the entire library and calculation of the percentage difference
    ...
    def completion(self, difference_percentage: int, max_length: int, max_diff_percent: int = 10) -> None:
        ...
        # max_diff_pourcent = pourcentage de difference maximal toléré
        # diff_pourcentage =  calculé à partir de la fonction check_length_seq_diff()
