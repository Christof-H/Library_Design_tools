...
class Locus:
    ...
    def check_nbr_probes(self, list_seq: list[list[int, int, str]]) -> list[list[int, int, str]]:
    ...
    def recover_genomic_seq(
        ...
        if  self.design_type == "locus_length":
            ...
            final_seq_list = seq_list_reduced[(locus-1)*self.nbr_probe_by_locus:(locus*self.nbr_probe_by_locus)]
